    ...
    <header>
      ...
      <body>
        <form class="login-form" method="POST" >
            <h2>Registrarse</h2>
            <?php
            include("C:/xampp/htdocs/Proyecto_Diosam-main/Proyecto_Diosam-main/conexion/conexion.php");
            include("C:/xampp/htdocs/Proyecto_Diosam-main/Proyecto_Diosam-main/controladores/registrar_user.php");
            
            ?>
            <div class="form-floating mb-3">
        
                <input minlength="4" maxlength="20" type="name" class="form-control" id="name_user" placeholder="Name" name="name_user" required autofocus>
